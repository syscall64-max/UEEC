...
#define UEEC_SECTION_HEADER_SIZE(format) \
    ((format) == UEEC_FORMAT_SH16 ? (size_t)sizeof(ueec_sh16) : \
     (format) == UEEC_FORMAT_SH32 ? (size_t)sizeof(ueec_sh32) : \
     (format) == UEEC_FORMAT_SH64 ? (size_t)sizeof(ueec_sh64) : (size_t)0)
